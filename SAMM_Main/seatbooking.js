...
const generateSeatsLayout = () => {
  ...
  // 12 rows of 4 seats (2 on each side of aisle)
  for (let i = 0; i < 12; i++) {
    layout.push([seatNumber++, seatNumber++, null, seatNumber++, seatNumber++]);
  }

  // Last row without aisle, 6 seats: 47-52
  layout.push([seatNumber++, seatNumber++, seatNumber++, seatNumber++, seatNumber++, seatNumber++]);
